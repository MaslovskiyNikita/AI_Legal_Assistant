    ...
    <div className="group relative flex items-center justify-center">
      ...
      <svg width="40" height="40" className="transform -rotate-90">
        ...
        <circle
          ...
          strokeLinecap="round"
          className="text-[#d946ef] transition-all duration-1000"
        />
      </svg>
...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen w-full bg-black text-white relative flex flex-col overflow-hidden font-sans">
      {/* Фоновое свечение */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[150%] h-[500px] bg-gradient-to-b from-[#d946ef]/30 via-[#a855f7]/10 to-transparent blur-[80px] pointer-events-none z-0"></div>
      ...
      <div className="relative z-10 flex items-center justify-between px-6 pt-12 pb-4">
        ...
        >
          <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-[#a855f7] to-[#d946ef] p-[2px]">
          ...
          <div className="relative flex items-center justify-center w-10 h-10 group cursor-help">
            <svg width="40" height="40" className="transform -rotate-90">
              ...
              <circle
                ...
                strokeLinecap="round"
                className="text-[#d946ef] transition-all duration-1000 ease-out"
              />
            </svg>
            ...
            return (
              <div
                ...
                className={`
                  ...
                  ${
                    isSelected
                      ? "border-fuchsia-500/80 shadow-lg shadow-fuchsia-900/40"
                ...
                style={
                  isSelected
                    ? {
                        background:
                          "linear-gradient(180deg, rgba(44,44,46,0.5) 0%, rgba(217,70,239,0.2) 100%), #1C1C1D",
                      }
                    : {}
                }
              >
                ...
                >
                  <Icon
                    size={16}
                    className={isSelected ? "text-[#d946ef]" : "text-white/70"}
                  />
                </div>
                {isSelected && agent.size === "large" && (
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-1/2 bg-[#d946ef]/30 blur-[40px]"></div>
                )}
            ...
            {quickPrompts.map((prompt, idx) => (
              ...
              >
                <div className="flex items-center gap-3 truncate pr-4">
                  <div className="w-10 h-10 rounded-full bg-[#d946ef]/20 flex items-center justify-center shrink-0">
                    <MessageSquare size={16} className="text-[#d946ef]" />
                  </div>
      ...
      <div className="relative z-10 px-6 pb-8 pt-2">
        <div className="flex items-center bg-[#1C1C1D] rounded-full p-2 border border-white/10 focus-within:border-[#d946ef]/50 transition-colors">
          <input
            type="text"
            value={inputText}
          ...
          <button
            ...
            className="w-10 h-10 rounded-full bg-[#d946ef] flex items-center justify-center transition-transform active:scale-95 shadow-lg shadow-fuchsia-500/20"
          >
